...
<html>
    ...
    <body>
        ...
        <div class="main_content">
            ...
            $result = mysql_query("select * from club,student where club.sno=student.sno and club.cname='{$cname}'");
            ...
            while($row = mysql_fetch_array($result)){
                ...
                echo"<td><a href='javascript:;'>加入</a><a href='javascript:;' class='detail' data-id='" .$row['cno']. "' style='margin-left: 20px;'>查看活动</a></td>" ;
            }
            echo "</tbody>";
            ?>
        </div>
